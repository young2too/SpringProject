...
<!-- Mirrored from educhamp.themetrades.com/demo/admin/mailbox-compose.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:35 GMT -->
<head>
	...
	<link rel="stylesheet" type="text/css" href="${contextPath }/resources/admin/assets/vendors/summernote/summernote.css">
	<link rel="stylesheet" type="text/css" href="${contextPath }/resources/admin/assets/vendors/file-upload/imageuploadify.min.css">
						...
						<div class="email-wrapper">
							<div class="email-menu-bar">
								<div class="compose-mail">
									<a href="mailbox-compose.jsp" class="btn btn-block">Compose</a>
								</div>
								<div class="email-menu-bar-inner">
									<ul>
										<li class="active"><a href="mailbox.jsp"><i class="fa fa-envelope-o"></i>Inbox <span class="badge badge-success">8</span></a></li>
										<li><a href="mailbox.jsp"><i class="fa fa-send-o"></i>Sent</a></li>
										<li><a href="mailbox.jsp"><i class="fa fa-file-text-o"></i>Drafts <span class="badge badge-warning">8</span></a></li>
										<li><a href="mailbox.jsp"><i class="fa fa-cloud-upload"></i>Outbox <span class="badge badge-danger">8</span></a></li>
										<li><a href="mailbox.jsp"><i class="fa fa-trash-o"></i>Trash</a></li>
									</ul>
								</div>
							</div>
...
<script src="${contextPath }/resources/admin/assets/vendors/summernote/summernote.js"></script>
<script src="${contextPath }/resources/admin/assets/vendors/file-upload/imageuploadify.min.js"></script>
...
<!-- Mirrored from educhamp.themetrades.com/demo/admin/mailbox-compose.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:45 GMT -->
</html>