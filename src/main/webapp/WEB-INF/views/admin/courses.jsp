				...
				<ul class="ttr-header-navigation">
					...
					<li>
						...
						<div class="ttr-header-submenu">
							<ul>
								<li><a href="../main/courses.jsp">나의 단어장</a></li>
						...
						<div class="widget-inner">
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic1.jpg" alt=""/>
								</div>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic2.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic3.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list admin-courses">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic4.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4>Become a PHP Master and Make Money</h4>
