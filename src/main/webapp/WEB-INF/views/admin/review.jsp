...
<!-- Mirrored from educhamp.themetrades.com/demo/admin/review.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:35 GMT -->
<head>
										...
										<ul class="card-courses-view">
											<li class="card-courses-user">
												<div class="card-courses-user-pic">
													<img src="${contextPath }/resources/admin/assets/images/testimonials/pic1.jpg" alt=""/>
												</div>
								...
								<div class="card-courses-full-dec">
									...
									<div class="card-courses-list-bx">
										<ul class="card-courses-view">
											<li class="card-courses-user">
												<div class="card-courses-user-pic">
													<img src="${contextPath }/resources/admin/assets/images/testimonials/pic2.jpg" alt=""/>
												</div>
												<div class="card-courses-user-info">
													<h5>Reviewer</h5>
													<h4>Keny White</h4>
