...
<!-- Mirrored from educhamp.themetrades.com/demo/admin/bookmark.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:09:05 GMT -->
<head>
						...
						<div class="widget-inner">
							<div class="card-courses-list bookmarks-bx">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic6.jpg" alt=""/>
								</div>
							...
							<div class="card-courses-list bookmarks-bx">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic7.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4 class="m-b5">Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list bookmarks-bx">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic8.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4 class="m-b5">Become a PHP Master and Make Money</h4>
							...
							<div class="card-courses-list bookmarks-bx">
								<div class="card-courses-media">
									<img src="${contextPath }/resources/admin/assets/images/courses/pic9.jpg" alt=""/>
								</div>
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4 class="m-b5">Become a PHP Master and Make Money</h4>
...
<!-- Mirrored from educhamp.themetrades.com/demo/admin/bookmark.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:10:19 GMT -->
</html>