				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12 col-xl-12">
							...
							<form name="frmQa" method="post" action="${contextPath}/viewQa.do"  >
							...
							<div class="info-bx">
								<ul class="media-post">
									...
									<hr>
									<textarea rows="10" cols="120"  name="qaContent"  id="i_content"  disabled />${qa.qaContent }</textarea>
									
									<hr>
									<div id="tr_btn_modify"  align="center" class="col-lg-12">
											<input type=button value="수정반영하기"  onClick="fn_modify_qa(frmQa)" class="btn button-md" >
											<input type=button value="취소"  onClick="backToList(frmQa)" class="btn button-md">
									</div>
									<p>
									<div id="tr_btn" align="center">
										<c:if test="${'hw' == qa.id }">
									      <input type=button value="수정하기" onClick="fn_enable(this.form)" class="btn button-md">
									      <input type=button value="삭제하기" onClick="fn_remove_qa('${contextPath}/removeQa.do', ${qa.qaNUM})" class="btn button-md">
									    </c:if>
									    <input type=button value="리스트로 돌아가기"  onClick="backToList(this.form)" class="btn button-md">
									     <input type=button value="답글쓰기"  onClick="fn_reply_form('${contextPath}/openReply.do', ${qa.qaNUM})" class="btn button-md">
									</div> 
