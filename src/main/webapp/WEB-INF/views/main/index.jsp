                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">	
							<li class="active"><a href="javascript:;">홈<i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">단어장</a></h4>
									<a href="#" class="btn radius-xl">더보기</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6">
...
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/jquery.themepunch.revolution.min.js"></script>
<!-- Slider revolution 5.0 Extensions  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="${contextPath }/resources/main_assets/assets/vendors/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script>
jQuery(document).ready(function() {
	...
	if(tpj("#rev_slider_486_1").revolution == undefined){
		...
		ttrevapi = tpj("#rev_slider_486_1").show().revolution({
			sliderType:"standard",
			jsFileLocation:"${contextPath }/resources/main_assets/assets/vendors/revolution/js/",
